        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-8 md:gap-16 mb-8 md:mb-16">
          ...
          <div className="text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-2.5 mb-3">
              <span className="bg-gradient-to-r from-purple-600 to-pink-500 text-white font-bold px-2 py-1 rounded-md text-sm">
                DS
              </span>
          ...
          <div className="hidden md:flex gap-16 lg:gap-24">
            <div>
              <h4 className="font-bold text-gray-900 text-sm uppercase  mb-4">Product</h4>
            ...
            <div>
              <h4 className="font-bold text-gray-900 text-sm uppercase mb-4">Company</h4>
              <ul className="space-y-3 text-sm text-gray-400">
            ...
            <div>
              <h4 className="font-bold text-gray-900 text-sm uppercase mb-4">Legal</h4>
              <ul className="space-y-3 text-sm text-gray-400">
